...
base_url();?>shopping/tambah" method="post" accept-charset="utf8">
 <a href="#"><img class="img-thumbnail" src="<?php
echo base_url() . 'assets/images/'.$row['gambar']; ?>"/></a>
 <div class="card-body">
 <h4 class="card-title">
 <a href="#"><?php echo
$row['nama_produk'];?></a>
...
$row['deskripsi'];?></p>
 ...
 <a href="<?php echo
base_url();?>shopping/detail_produk/<?php echo
$row['id_produk'];?>" class="btn btn-sm btn-default"><i
